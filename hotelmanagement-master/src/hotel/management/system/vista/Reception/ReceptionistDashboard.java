package hotel.management.system.vista.Reception; // Cambia el paquete a uno apropiado
...
public class ReceptionistDashboard extends JFrame implements ActionListener {
    ...
    public ReceptionistDashboard() {
        ...
        sidePanel.setLayout(new GridLayout(6, 1, 10, 10)); // Cambiado a 6 filas para incluir el encabezado

        // Encabezado
        headerLabel = new JLabel("Perfil de Recepcionista", SwingConstants.CENTER);
